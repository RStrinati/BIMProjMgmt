...
export const PROJECT_FIELD_REGISTRY: ProjectFieldDefinition[] = [
  ...
  {
    id: 'deliverables_due_total',
    label: 'Deliverables Due (Total)',
    format: 'number',
    aggregatable: 'sum',
    editable: false,
    defaultVisibility: { list: true, board: false, timeline: false },
    accessor: (project) => project.deliverables_due_total,
    align: 'right',
    width: 160,
  },
  {
    id: 'deliverables_due_next_week',
    label: 'Due Next Week',
    format: 'number',
    aggregatable: 'sum',
    editable: false,
    defaultVisibility: { list: true, board: false, timeline: false },
    accessor: (project) => project.deliverables_due_next_week,
    align: 'right',
    width: 140,
  },
  {
    id: 'deliverables_due_next_fortnight',
    label: 'Due Next Fortnight',
    format: 'number',
    aggregatable: 'sum',
    editable: false,
    defaultVisibility: { list: true, board: false, timeline: false },
    accessor: (project) => project.deliverables_due_next_fortnight,
    align: 'right',
    width: 150,
  },
  {
    id: 'deliverables_due_next_month',
    label: 'Due Next Month',
    format: 'number',
    aggregatable: 'sum',
    editable: false,
    defaultVisibility: { list: true, board: false, timeline: false },
    accessor: (project) => project.deliverables_due_next_month,
    align: 'right',
    width: 140,
  },
  {
    id: 'deliverables_due_next_quarter',
    label: 'Due Next Quarter',
    format: 'number',
    aggregatable: 'sum',
    editable: false,
    defaultVisibility: { list: true, board: false, timeline: false },
    accessor: (project) => project.deliverables_due_next_quarter,
    align: 'right',
    width: 150,
  },
  {
