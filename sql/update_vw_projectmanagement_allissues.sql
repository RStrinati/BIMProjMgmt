...
SELECT
    'ACC' AS source,
    CAST(ve.issue_id AS NVARCHAR(100)) AS issue_id,
    CAST(ve.issue_id AS NVARCHAR(100)) AS source_issue_id,
    ve.title,
    ve.status,
    ...
    CAST(acc.created_by AS NVARCHAR(255)) AS created_by,
    CAST(acc.updated_by AS NVARCHAR(255)) AS updated_by,
    CAST(acc.closed_by AS NVARCHAR(255)) AS closed_by,
    acc.linked_document_urn,
    acc.snapshot_urn,
    NULL AS web_link,
...
SELECT
    'Revizto' AS source,
    CAST(rv.issueId AS NVARCHAR(100)) AS issue_id,
    ...
    rv.author_email AS created_by,
    NULL AS updated_by,
    NULL AS closed_by,
    NULL AS linked_document_urn,
    NULL AS snapshot_urn,
    rv.web_link,
