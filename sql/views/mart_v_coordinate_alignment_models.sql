-- ============================================================================
-- View: mart.v_coordinate_alignment_models
-- Purpose: Latest coordinate alignment per model file for dashboard tables
-- Author: System
-- Created: 2026-01-06
-- ============================================================================
...
IF OBJECT_ID('mart.v_coordinate_alignment_models', 'V') IS NOT NULL
    DROP VIEW mart.v_coordinate_alignment_models;
GO

CREATE VIEW mart.v_coordinate_alignment_models AS
WITH Latest AS (
    SELECT
        alignment_id,
        ROW_NUMBER() OVER (
            PARTITION BY project_key, model_file_name
...
SELECT
    ...
    f.model_file_name,
    f.control_file_name,
    f.discipline_full_name AS discipline,
    f.model_zone_code,
    f.control_zone_code,
    ...
    f.pbp_northsouth,
    f.pbp_elevation,
    f.pbp_angle_true_north,
    f.survey_eastwest,
    f.survey_northsouth,
    f.survey_elevation,
    f.survey_angle_true_north,
