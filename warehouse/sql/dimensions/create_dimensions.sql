...
BEGIN
    CREATE TABLE dim.issue (
        ...
        linked_document_urn     NVARCHAR(255)  NULL,
        snapshot_urn            NVARCHAR(255)  NULL,
        web_link                NVARCHAR(1000) NULL,
        preview_middle_url      NVARCHAR(1000) NULL,
        issue_link              NVARCHAR(1000) NULL,
        snapshot_preview_url    NVARCHAR(1000) NULL,
        is_deleted              BIT            NULL,
